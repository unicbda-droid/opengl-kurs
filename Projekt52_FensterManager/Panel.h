...
public:
    ...
    virtual bool hasKeyboardFocus() const { return m_keyboardFocus; }
    virtual void setKeyboardFocus(bool on) { m_keyboardFocus = on; }
    virtual Panel* findKeyboardFocusedPanel();
    virtual void forAllPanels(const std::function<void(Panel*)>& cb) {}
