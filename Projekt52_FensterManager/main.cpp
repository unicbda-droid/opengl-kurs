...
static void onChar(GLFWwindow*, unsigned int c) { if (g_wm) g_wm->onChar(c); }

int main() {
    if (!glfwInit()) { std::cerr << "glfwInit failed\n"; return -1; }

    GLFWwindow* window = glfwCreateWindow(1280, 720, "Projekt 52 - FensterManager", nullptr, nullptr);
